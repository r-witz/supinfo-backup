$(document).ready(function () {
    ...
    //Audio Vars
    backAudio = new Audio('angryBirdsTheme.mp3');
    barAudio = new Audio('bird.mp3');
    bonusBirthAudio = new Audio('smb_powerup_appears.wav');
    bonusAudio = new Audio('bonus1.mp3');
    gameOverAudio = new Audio('gameEnd.mp3');
    gameWinAudio = new Audio("gameEnd.mp3");
    ...
    function generateBoard() {
        $gameInfo.css("left", $(window).width() - $gameInfo.width());
        ...
        for (var currentRow = 0; currentRow < nbrRow; currentRow++) {
            ...
            for (var currentColumn = 0; currentColumn < nbrColumns; currentColumn++) {
                ...
                if (generateCell <= 20) {
                    ...
                    $newBrick.css({
                        "background-image": "url('brick" + (Math.floor(Math.random() * 3) + 1) + ".png')",
    ...
    function buildBreakableList() {
        ...
        $("td").each(function () {
            brickID++;
            if ($(this).attr("ID").toString().indexOf("black") !== -1) {
            } else {
                console.log($(this).css("backgroundImage").toString());
                bricksound = $(this).css("backgroundImage").toString().charAt($(this).css("backgroundImage").toString().indexOf("brick")+5);
                console.log(bricksound);
                brickInfo = {
                    "Top": $(this).offset().top,
    ...
    function brickTouched(nbrBriques) {
        brickAudio = new Audio(bricksList[nbrBriques].Sound);
        brickAudio.play();
    ...
    function bonusBallAdder() {
        ...
        bonusBallsHistory++;
        ballAudio = new Audio ("bonus3.mp3");
        ballAudio.play();
